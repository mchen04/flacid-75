...
export const operationSchema = z.discriminatedUnion('type', [
 ...
 z.object({...common, type: z.literal('session'), habit: z.enum(['walk', 'workout', 'abs']), seconds: n(0, 86400), done: z.boolean(), items: z.array(strOptional(60)).max(40).optional(), routine: strOptional(60).optional()}),
