...
export const size={hairline:'1px',bw:'2px',ring:'3px',dot:'6px',meter:'8px',handle:'36px',icon:'22px',minus:'32px',cell:'36px',tap:'44px',disc:'56px',add:'56px',tile:'64px',nav:'64px',glass:'76px',bowl:'84px',bars:'112px',pair:'184px',hero:'300px',heroShort:'200px',spark:'100px',preview:'50dvh',shell:'440px',shellMax:'960px',sheet:'90dvh'} as const;
