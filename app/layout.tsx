...
import './tokens.css';
import './globals.css';
export const metadata:Metadata={title:'My Wellness',description:'Your daily wellness companion.',manifest:'/manifest.webmanifest',appleWebApp:{capable:true,statusBarStyle:'default',title:'My Wellness',startupImage:[{url:'/splash-1170x2532.png',media:'(device-width: 390px) and (device-height: 844px) and (-webkit-device-pixel-ratio: 3)'}]},icons:{icon:'/icon.svg',apple:'/apple-touch-icon.png'},robots:{index:false,follow:false}};
