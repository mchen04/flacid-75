...
const code=result.outputFiles[0].contents;const css=await readFile('app/tokens.css','utf8')+await readFile('app/globals.css','utf8');const id=createHash('sha256').update(code).update(css).update(sw).digest('hex').slice(0,12);
