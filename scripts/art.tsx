...
await writeFile('public/art/gate.svg',`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 310" class="scene gate-scene" aria-hidden="true">${scene}</svg>`);
const splash=`<svg xmlns="http://www.w3.org/2000/svg" width="1170" height="2532"><defs><clipPath id="card"><rect x="60" y="966" width="1050" height="600" rx="72"/></clipPath></defs><rect width="1170" height="2532" fill="${color.ground}"/><g clip-path="url(#card)"><svg x="60" y="966" width="1050" height="600" viewBox="0 0 360 310" preserveAspectRatio="xMidYMax slice">${scene}</svg></g></svg>`;
