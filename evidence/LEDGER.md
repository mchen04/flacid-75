...
| The week strip returns to Today as a filled-circle strip. Tapping a past day selects it for backfill; tapping today comes back. | Version 2 removed a decorative week strip. Reference A's week strip is the signature of its home screen, and this one carries meaning: kept days are tinted sage, the active day is the accent circle, and it replaces the old "Back to today" flow. |
