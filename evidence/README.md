...
Version 4 (My Wellness, 2026-09-10; repaired after independent reviews 164, 165, 171 and 173 and approved by independent review 175 at 38b978f, application commit b370965: 183 of 183 real-server tests on both engines, see `my-wellness/final175/` and the supervisor's own run in `my-wellness/final174/`; merged into `main` by Michael through pull request #1 on 2026-09-11, merge commit f96cc4b, GitHub Production deployment 6386909969 succeeded): start with [my-wellness/ACCEPTANCE.md](my-wellness/ACCEPTANCE.md) (scope matrix 1–19, commands, limitations), [my-wellness/RULES.md](my-wellness/RULES.md) and [my-wellness/DESIGN.md](my-wellness/DESIGN.md); captures under `my-wellness/before/` and `my-wellness/after/`. Earlier evidence below is retained unchanged.
