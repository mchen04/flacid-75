...
test('no horizontal scroll, drag or overflow on any page at 390x844; vertical scroll only inside the page',async({page})=>{
 await open(page,seed(40));
 ...
 await writeFile('evidence/my-wellness/horizontal-audit.json',JSON.stringify(reports,null,2));
