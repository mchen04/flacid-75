...
export function Food() {
 ...
 return <section className="activity">
  ...
  <p className="fine-print">Calories count when the day lands inside the range; protein when it reaches the target. Estimates come from your words or photo and are always yours to correct. Nothing is sent anywhere except the meal you describe.</p>
 </section>;
}
